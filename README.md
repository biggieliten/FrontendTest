...
## How to use
- git clone https://github.com/biggieliten/FrontendTest
- Open the terminal and navigate into root (FrontendTest folder)
- Run `npm i`
- Run `npm run dev` and follow the localhost
